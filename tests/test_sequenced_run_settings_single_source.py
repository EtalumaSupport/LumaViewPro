...
autofocus-scan path is intentionally exempt: it must NOT hold the LED across
focus moves (photobleaching), so it does not spread the helper and is
identified by its SINGLE_AUTOFOCUS_SCAN run_mode.
"""
