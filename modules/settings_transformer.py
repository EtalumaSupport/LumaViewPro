...
class SettingsTransformer:
    ...
    def _transform_perimeter(self, settings, pixels_per_um):
        ...
        return {'min': _process_val(settings['min']), 'max': _process_val(settings['max'])}
    ...
    def _transform_filters(self, settings, pixels_per_um):
        return {
            ...
            'perimeter': self._transform_perimeter(
                settings=settings['perimeter'], pixels_per_um=pixels_per_um
            ),
